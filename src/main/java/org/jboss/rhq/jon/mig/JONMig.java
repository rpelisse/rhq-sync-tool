...
import org.jboss.rhq.jon.mig.cli.CLIAction;
import org.jboss.rhq.jon.mig.cli.Exporter;
import org.jboss.rhq.jon.mig.cli.Importer;
import org.jboss.rhq.jon.mig.cli.PasswordEncoder;
...
import org.jboss.rhq.jon.mig.util.SystemUtils;
 ...
 *
 */
public final class JONMig {

    private static Logger logger = Logger.getLogger(JONMig.class);
    private static String PROG_NAME = "JONMig";
	/**
	 *
	 * @param args
	 */
	public static void main(String[] args) {
		CLIParameters parameters = JONMig.extractParameters(args);
